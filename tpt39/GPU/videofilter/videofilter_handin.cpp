...
// 1 ... triple gauß
// 2 ... scharr
// 3 ... triple gauß and scharr
#define FILTERTYPE 3

// SOBELTYPE
// 0 ... low quality (calculation with shorts)
// 1 ... high quality (calculation with floats)
# define SOBELTYPE 0
...
int main(int, char**)
{
    ...
    # endif
    # if SOBELTYPE == 1
    kernelSobel = clCreateKernel(program, "sobelHR", NULL);
    # endif
    ...
    for (int count=0; count < N_FRAMES; count ++) {
        ...
        const size_t local_work_size[2]= {N_WGX, N_WGY};
